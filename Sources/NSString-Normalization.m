...
- (NSString*)normalizedStringWithNFKC_CF
{
    ...
    CHECK_ERROR("u_strFromUTF8");
    
    const UNormalizer2 *norm2 = unorm2_getNFKCCasefoldInstance(&e);
    CHECK_ERROR("unorm2_getNFKCCasefoldInstance");
    
    UChar *utf16_dest = (UChar*)malloc(sizeof(UChar) * length);
    unorm2_normalize(norm2, utf16_src, -1, utf16_dest, length, &e);
    ...
    return [NSString stringWithUTF8String:utf8_dest];
}
@end
