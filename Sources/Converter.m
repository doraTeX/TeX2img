...
- (BOOL)pdfcrop:(NSString*)pdfPath outputFileName:(NSString*)outputFileName page:(NSUInteger)page addMargin:(BOOL)addMargin
{
    ...
    [cropTeX writeToFile:[cropFileBasePath stringByAppendingString:@".tex"] atomically:NO encoding:NSUTF8StringEncoding error:nil];
    ...
    [fileManager removeItemAtPath:[cropFileBasePath stringByAppendingString:@".tex"] error:nil];
    [fileManager removeItemAtPath:[cropFileBasePath stringByAppendingString:@".log"] error:nil];
    ...
    [fileManager moveItemAtPath:[cropFileBasePath stringByAppendingString:@".pdf"] toPath:outputFileName error:nil];
